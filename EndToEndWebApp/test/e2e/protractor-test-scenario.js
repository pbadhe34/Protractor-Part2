...
console.log("The Browser object features listed \n\n");
   ...
   */
    ...
    browser.get('http://localhost:8080/EndToEndTest/app/index.html');
...
*/   
  ...
  describe('Phone model list view test', function() {
    ...
    beforeEach(function() {
      browser.get('http://localhost:8080/EndToEndTest/app/index.html#/phones');
    });
...
beforeEach(function() {
      ('http://localhost:8080/EndToEndTest/app/index.html#/phones/nexus-s');
    }); 
...
//failure at this test
      expect(element(by.css('img.phone')).getAttribute('src')).toMatch(/img\/phones\/nexus-s.01.jpg/);
    });
