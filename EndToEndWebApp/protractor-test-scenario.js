...
console.log("The Browser object features listed \n\n");
   ...
   */
    ...
    browser.get('http://localhost:8090/EndToEndWebApp/app/');
...
*/   
  ...
  describe('Phone model list view test', function() {
    ...
    beforeEach(function() {
      browser.get('http://localhost:8090/EndToEndWebApp/app/index.html#/phones');
    });
...
beforeEach(function() {
 browser.get  ('http://localhost:8090/EndToEndWebApp/app/index.html#/phones/nexus-s');
    }); 
